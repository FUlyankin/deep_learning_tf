...
\begin{frame}{Про пары}
	\begin{wideitemize}
		...
		\item все материалы можно найти на  \href{https://github.com/FUlyankin/deep_learning_tf}{страничке курса}
	\end{wideitemize} 
\end{frame}
...
\begin{frame}{Многослойная формула оценки}
	\begin{wideitemize}
		\item \alert{Домашние задания:} пять штук с кодом на питоне
		...
		\item Формула оценивания на \href{https://github.com/FUlyankin/deep_learning_tf}{страничке курса}
	\end{wideitemize}
\end{frame}
