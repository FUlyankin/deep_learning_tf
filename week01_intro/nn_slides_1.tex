...
\begin{frame}{Про пары}
	\begin{wideitemize}
		...
		\item все материалы можно найти на  \href{https://github.com/FUlyankin/neural_nets_dpo}{страничке курса}
	\end{wideitemize} 
\end{frame}
...
\item Бесплатный \href{https://stepik.org/course/50352/syllabus}{курс по pytorch от Samsung.}  Вводный курс в нейросетки на pytorch. Состоит из двух частей: CV и NLP. \alert{Для тех, кто  хочет писать на pytorch.}
...
\begin{frame}{Мощь библиотек (немного устарело) }

\begin{columns}[T] % align columns
	\begin{column}{.48\textwidth}
		\centering  \includegraphics[width=.9\linewidth]{frameworks.png}
	\end{column}%
	\hfill%
	\begin{column}{.48\textwidth}
		\centering 	\includegraphics[width=.9\linewidth]{frameworks_2019.png}
	\end{column}%
\end{columns}
\vfill %
