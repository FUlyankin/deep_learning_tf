...
- [__week09__](./week09_rnn) Рекурентные нейронные сетки: RNN, LSTM, GRU. Временные ряды. (4 мая)
- [__week10__](./week10_nlp_w2v) Работа с текстами, введение в NLP, идея эмбедингов: w2v. (11 мая)
- [__week11__](./week11_autoencoders) Автокодировщики: тексты, картинки, нейросети для графов  (18 мая)
- [__week12__]( ) Seq2seq модели. Механизмы внимания. Автопереводчики. Генерация текстов. (25 мая)
